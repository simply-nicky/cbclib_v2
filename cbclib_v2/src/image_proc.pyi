...
from ..annotations import RealArray, IntArray, Shape, Table
...
def draw_line_table(lines: RealArray, shape: Shape, idxs: Optional[IntArray]=None,
                    max_val: float=1.0, kernel: str='rectangular', num_threads: int=1) -> Table:
