...
from .annotations import (AnyType, Array, ArrayNamespace, DataclassInstance, ExpandedType, JaxArray,
                          NumPy, UnionType)
...
class StringFormatting:
    ...
    formatters : FormatterDict = {'array': ArrayFormatter,
                                  'list': ListFormatter,
