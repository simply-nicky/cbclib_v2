...
from ..annotations import Array, CPPIntSequence, CPPRealSequence, NDRealArray
...
class PointSet3D:
    ...
    def __init__(self, x: CPPIntSequence, y: CPPIntSequence, z: CPPIntSequence):
        ...
...
@overload
def label(mask: Array, structure: Structure, seeds: None=None, npts: int=1,
          axes: List[int] | None=None, num_threads: int=1) -> ListRegions | Regions:
    ...

@overload
def label(mask: Array, structure: Structure, seeds: List[PointSet], npts: int=1,
          axes: List[int] | None=None, num_threads: int=1) -> ListRegions:
    ...

@overload
def label(mask: Array, structure: Structure, seeds: PointSet, npts: int=1,
          axes: None=None, num_threads: int=1) -> Regions:
    ...
