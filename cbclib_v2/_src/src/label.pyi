...
from ..annotations import BoolArray, IntArray, NDBoolArray, NDIntArray, NDRealArray, RealArray
...
LabelResult = Tuple[IntArray, IntArray]
...
def total_mass(labels: LabelResult, data: NDRealArray, num_threads: int=1) -> NDRealArray: ...

def mean(labels: LabelResult, data: NDRealArray, num_threads: int=1) -> NDRealArray: ...

def center_of_mass(labels: LabelResult, data: NDRealArray, num_threads: int=1) -> NDRealArray: ...

def moment_of_inertia(labels: LabelResult, data: NDRealArray, num_threads: int=1) -> NDRealArray: ...

def covariance_matrix(labels: LabelResult, data: NDRealArray, num_threads: int=1) -> NDRealArray: ...

def line_fit(labels: LabelResult, data: NDRealArray, num_threads: int=1) -> NDRealArray: ...

def maximum_position(labels: LabelResult, data: NDRealArray | NDIntArray,
                     num_threads: int=1) -> NDIntArray: ...

def p_values(labels: LabelResult, lines: RealArray, data: NDRealArray, p0: float, vmin: float,
             xtol: float, num_threads: int=1) -> NDRealArray: ...
