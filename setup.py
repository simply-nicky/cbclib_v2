...
extensions = [Pybind11Extension("cbclib_v2._src.src.fft_functions",
                                sources=["cbclib_v2/_src/src/fft_functions.cpp"],
                                define_macros = [('VERSION_INFO', __version__)],
                                libraries = ['fftw3', 'fftw3f', 'fftw3l', 'fftw3_omp',
                                             'fftw3f_omp', 'fftw3l_omp'],
                                **extension_args),
              Pybind11Extension("cbclib_v2._src.src.kd_tree",
                                sources=["cbclib_v2/_src/src/kd_tree.cpp"],
                                define_macros = [('VERSION_INFO', __version__)],
                                **extension_args),
              Pybind11Extension("cbclib_v2._src.src.image_proc",
                                sources=["cbclib_v2/_src/src/image_proc.cpp"],
                                define_macros = [('VERSION_INFO', __version__)],
                                **extension_args),
